...
class HandPoseVisualizer():
    ...
    def __init__(self):
        ...
        self.pose_pub = rospy.Publisher(
            '_output/pose', PoseArray, queue_size=1)
        ...
        self.subs = [sub_hand_pose, sub_rgb_image, sub_depth_image]
    ...
    def callback(self, hand_pose_msg, rgb_msg, depth_msg):
        ...
        for people_pose in zip(hand_pose_msg.poses):
            ...
            for pose, limb in zip(poses, limbs):
                ...
                kernel = depth_image[lt[1]:rb[1], lt[0]:rb[0]]
                d = kernel.mean()
                print(limb, d)
